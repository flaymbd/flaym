...
export default function MenuPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto w-full px-6 py-12">
      ...
      >
        <h1 className={`font-display text-6xl md:text-8xl uppercase tracking-tight transition-colors duration-300 ${isSystemDark ? 'text-cream' : 'text-charcoal'}`}>Our <span className="text-ember">Menu</span></h1>
      ...
      <div className="max-w-md mx-auto mb-6 relative z-20">
        <div className="relative flex items-center">
          ...
          <input
            ...
            className={`w-full backdrop-blur-md border focus:border-ember focus:outline-none py-3.5 pl-12 pr-10 transition-all uppercase tracking-wider text-xs font-bold ${isSystemDark ? 'bg-charcoal/60 border-cream/10 text-cream placeholder-cream/40' : 'bg-white/70 border-gray-200 text-charcoal placeholder-gray-400'}`}
          />
          {searchQuery && (
            <button

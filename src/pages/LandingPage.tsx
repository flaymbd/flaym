    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            <Link to="/menu" className="bg-ember text-charcoal font-bold py-4 px-10 text-xl hover:bg-ember/90 transition-all shadow-[0_0_20px_rgba(255,90,31,0.4)] uppercase tracking-wider">
              Order Now
            </Link>
      ...
      {/* About Section */}
      <section id="about" className={`py-24 px-6 transition-colors duration-500 ${isSystemDark ? 'bg-charcoal' : 'bg-white'}`}>
      ...
      {/* Menu Highlights */}
      <section className={`py-24 px-6 border-t border-b transition-colors duration-500 ${isSystemDark ? 'bg-charcoal border-ember/10' : 'bg-white border-gray-100'}`}>
      ...
      {/* Why Flaym */}
      <section className={`py-24 px-6 transition-colors duration-500 ${isSystemDark ? 'bg-charcoal' : 'bg-white'}`}>
      ...
      {/* Testimonials */}
      <section className={`py-24 px-6 border-t transition-colors duration-500 ${isSystemDark ? 'bg-charcoal border-ember/10' : 'bg-white border-gray-200'}`}>
